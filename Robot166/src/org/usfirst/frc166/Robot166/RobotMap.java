...
public class RobotMap {
    ...
    public static Solenoid ballManipulatorSolenoid;
	...
	LiveWindow.addSensor("Transmission", "Pressure Sensor", transmissionPressureSensor);
        ...
        ballManipulatorSolenoid = new Solenoid(1, 2);
	LiveWindow.addActuator("Ball Manipulator", "Solenoid", ballManipulatorSolenoid);
