...
public class OI {
    ...
    public OI() {
        ...
        alignDistance.whileHeld(new AutoAlign());
        ...
        SmartDashboard.putData("NEW Align Robot To Shooting Distance", new AlignRobotToShootingDistance());
...
//        SmartDashboard.putData("Wait For Ball Loaded", new WaitForBallLoaded());
        ...
        //SmartDashboard.putData("Align To Shoot Distance", new AutoAlign());
