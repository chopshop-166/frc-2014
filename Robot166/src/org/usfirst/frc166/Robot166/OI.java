...
public class OI {
    ...
    public JoystickButton autoLoadButton;
    ...
    public OI() {
        ...
        autoLoadButton = new JoystickButton(leftDriveJoy, 1);
        autoLoadButton.whenPressed(new AutoLoad());
        ...
        SmartDashboard.putData("Move Ball Holder Out", new MoveBallHolderOut());
        SmartDashboard.putData("Move Ball Holder In", new MoveBallHolderIn());
        SmartDashboard.putData("Auto Load", new AutoLoad());
