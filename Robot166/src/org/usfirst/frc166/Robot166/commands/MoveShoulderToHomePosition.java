 ...
 *
 */
public class MoveShoulderToHomePosition extends Command {

    public MoveShoulderToHomePosition() {
    ...
    protected void end() {
        Robot.shoulder.stop();
        Robot.shoulder.setShoulderLocation(Shoulder.Position.Home);
    }
