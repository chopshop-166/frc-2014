...
public class Timing extends Subsystem {
    ...
    private static final double MATCH_LENGTH = 120;
    ...
    /**
     * Get the time since autonomous started
     *
     * @return The number of seconds since autonomous started
     */
    ...
    /**
     * Get the time since teleop started
     *
     * @return The number of seconds since teleop started
     */
    public double getCurrentTeleopTime() {
