...
//    Joystick shoulderJoy = Robot.oi.copilotJoy;
    ...
    public static final double SHOULDER_SPEED = .4;
    public static final double HOME_POSITION_HIGH = 4.521;
    public static final double HOME_POSITION_LOW = 4.443;
    public static final double IN_POSITION_HIGH = 4.36;
    public static final double OUT_POSITION_LOW = 4.668;
