...
public class Shoulder extends Subsystem {
    ...
    public static final double SHOULDER_SPEED = .65;
    public static final double SHOULDER_OUT_SPEED = .35;
    public static final double HOME_POSITION_HIGH = 1.859;
    public static final double HOME_POSITION_LOW = 1.833;
    public static final double IN_POSITION_HIGH = 1.740;
    public static final double OUT_POSITION_LOW = 2.152;
