...
public class Drive extends Subsystem {
    ...
    private static final int DISTANCE_TO_WALL = 1500;
    private static final double ULTRASONIC_VOLTSTOCM = 9001;
...
//determines whether wall is close enough for stop
    ...
    public boolean isWallNear() {
        try {
            //distance = getCrioUltrasonicVal(); //CRIO sensor
            distance = getUltrasonicVal(); //Arduino Sensor
    ...
    int getCrioUltrasonicVal() {
        return (int) (ultrasonic.getVoltage() * ULTRASONIC_VOLTSTOCM);
    }
